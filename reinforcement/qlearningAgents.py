...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        updated_value = (1-alpha)*qvalue + alpha*(reward + discount*next_value)
...
class PacmanQAgent(QLearningAgent):
    ...
    def __init__(self, epsilon=0.05,gamma=0.9,alpha=0.2, numTraining=10, **args):
        """
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        correction = (reward + discount*next_value) - qvalue
        for f in F:
            self.weights[f] += alpha*correction*F[f]
        # util.raiseNotDefined()
